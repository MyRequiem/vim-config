...
silent only
silent tabonly
cd ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-3-build_basic_system
...
badd +1 ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-1-getting_started/wget-list
badd +1 ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-3-build_basic_system/queue
argglobal
%argdel
tabnew +setlocal\ bufhidden=wipe
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-3-build_basic_system
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
keepjumps 10
normal! 0
lcd ~/projects/git/LFS/stage-1-lfs-stable-x86_64
tabnext
edit ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-1-getting_started/wget-list
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
keepjumps 1
normal! 0
lcd ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-3-build_basic_system
tabnext
edit ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-3-build_basic_system/queue
argglobal
balt ~/projects/git/LFS/stage-1-lfs-stable-x86_64/stage-1-getting_started/wget-list
let s:cpo_save=&cpo
set cpo&vim
xmap <buffer> -hs <Plug>(GitGutterStageHunk)
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
