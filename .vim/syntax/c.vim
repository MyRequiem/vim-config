...
hi Error term=NONE ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE
hi Float term=NONE ctermfg=197 ctermbg=NONE guifg=#FF005F guibg=NONE
syn match Float /\d\+\(\.\d\)\=/
hi Colon term=NONE ctermfg=15 ctermbg=NONE guifg=#FFFFFF guibg=NONE
syn match Colon /;/
hi Equal term=NONE ctermfg=15 ctermbg=NONE guifg=#FFFFFF guibg=NONE
syn match Equal /=/
hi Braces term=NONE ctermfg=10 ctermbg=NONE guifg=#55FF55 guibg=NONE
syn match Braces /[}{]/
